...
const ROWS: Row[] = [
  ['kaplan-dark', 'Kaplan Dark', true, ['#131110','#1b1815','#241f1a','#0f0d0a','#322b22','#4a3e30','#ece6db','#a59a89','#6f6557','#f59e42','#fb923c','rgba(245,158,66,0.14)','#6cc56c','#e0b03a','#e5564b','#7c8390','#5aa9e6']],
  ['midnight', 'Midnight', true, ['#0e1116','#161b22','#1c232c','#0a0d12','#232a33','#38424f','#e6edf3','#9aa7b4','#636e7b','#58a6ff','#79c0ff','rgba(88,166,255,0.14)','#56d364','#e3b341','#f85149','#6e7681','#58a6ff']],
  ['dim', 'Dim (medium)', true, ['#1c2128','#22272e','#2d333b','#171b21','#373e47','#4a525c','#cdd9e5','#909dab','#697483','#6cb6ff','#96d0ff','rgba(108,182,255,0.14)','#6bc46d','#daaa3f','#e5534b','#768390','#6cb6ff']],
  ['nord', 'Nord', true, ['#2e3440','#343b49','#3b4252','#272c36','#434c5e','#4c566a','#eceff4','#d8dee9','#7b8494','#88c0d0','#8fbcbb','rgba(136,192,208,0.16)','#a3be8c','#ebcb8b','#bf616a','#6f7787','#81a1c1']],
...
const VAR_KEYS = [
  '--bg','--bg-elev','--bg-elev-2','--bg-term','--border','--border-strong',
  '--text','--text-dim','--text-faint','--accent','--accent-strong','--accent-soft',
